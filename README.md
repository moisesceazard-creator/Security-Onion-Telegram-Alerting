...
and design rationale, or jump straight to
[`docs/DEPLOYMENT_GUIDE.md`](docs/DEPLOYMENT_GUIDE.md) to replicate this on
your own Security Onion install.
...
└── docs/
    ...
    ├── DEPLOYMENT_GUIDE.md      # step-by-step: replicate this from scratch
    ├── TESTING.md               # how to safely trigger/validate each rule
...
assumes an existing Security Onion 2.4 deployment. Full walkthrough in
[`docs/DEPLOYMENT_GUIDE.md`](docs/DEPLOYMENT_GUIDE.md); short version:
...
4. Re-apply the ElastAlert Salt state / restart the `so-elastalert`
   container.
5. Validate each rule fires end-to-end — see
...
[MIT](LICENSE) — free to use, modify, and redistribute for anyone
replicating or building on this capstone. Update the copyright holder name
in [`LICENSE`](LICENSE) before publishing.
